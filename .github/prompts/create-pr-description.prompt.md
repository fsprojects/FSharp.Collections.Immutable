---
mode: agent
description: Generates a pull request description for FSharp.Collections.Immutable by analyzing the current branch's changes and filling in the project's PR template.
---
