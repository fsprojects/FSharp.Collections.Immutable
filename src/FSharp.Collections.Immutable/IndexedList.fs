...
module IndexedList =
    ...
    let inline empty<'T> : IndexedList<'T> = System.Collections.Immutable.ImmutableList.Create<'T> ()
    let inline ofSeq source : IndexedList<'T> = System.Collections.Immutable.ImmutableList.CreateRange source
