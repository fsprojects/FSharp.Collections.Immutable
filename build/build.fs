...
let productName = "FSharp.Collections.Immutable"

let sln = rootDirectory </> "FSharp.Collections.Immutable.slnf"
...
let gitRepoName = "FSharp.Collections.Immutable"
        ...
        p with
            ...
            Parameters =
                Some [
                    ...
                    "fsdocs-logo-src",
                    quoted (
                        "https://raw.githubusercontent.com/fsprojects/FSharp.Collections.Immutable/refs/heads/main/docsSrc/content/logo.png"
                    )
                ]
            Strict = Some true
    }
